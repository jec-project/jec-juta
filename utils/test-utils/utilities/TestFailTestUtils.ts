...
/*!
 * This module constains utilities used by the TestClassFailTest test suite.
 */

// Utilities:
const VALID_CLASS:string = process.cwd() + "/utils/test-utils/classes/annotations/TestClassTestClass";
