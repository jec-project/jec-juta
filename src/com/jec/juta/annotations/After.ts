...
/**
 * The <code>@After</code> decorator defines a method in the JUTA API which is 
...
export function After(params?:AnnotatedMethodParams):Function {
  ...
  return function(target:any, key:string,
    ...
    const ctx:JcadContext =
                         CTXM.getContext(JutaConnectorRefs.AFTER_CONNECTOR_REF);
    return DCM.getDecorator(JutaConnectorRefs.AFTER_CONNECTOR_REF, ctx)
