...
describe("BeforeClass", ()=> {
  ...
  before(()=> {
    ...
    annotationSpy = sinon.spy(BeforeClassAnnotation, "BeforeClass");
  });
  ...
  describe("@BeforeClass", ()=> {
    ...
    it("should invoke the JcadContextManager with the JutaConnectorRefs.BEFORE_CLASS_CONNECTOR_REF reference", function() {
      ...
      sinon.assert.calledWith(
        getContextSpy, JutaConnectorRefs.BEFORE_CLASS_CONNECTOR_REF
      );
    });
    ...
    it("should invoke the DecoratorConnectorManager with the JutaConnectorRefs.BEFORE_CLASS_CONNECTOR_REF reference and the correct JCAD context", function() {
      ...
      sinon.assert.calledWith(
        getDecoratorSpy,
        JutaConnectorRefs.BEFORE_CLASS_CONNECTOR_REF, context
      );
    });
    ...
    it("should invoke the registered decorator with the right method name and parameters", function() {
      ...
      /*sinon.assert.calledWith(
        ...
        testInstance,
        utils.KEY,
        utils.params.ANNOTATED_METHOD_PARAMS
      );*/
    });
  });
});
