...
function Before(params) {
    return function (target, key, descriptor) {
        const ctx = CTXM.getContext(JutaConnectorRefs_1.JutaConnectorRefs.BEFORE_CONNECTOR_REF);
        return DCM.getDecorator(JutaConnectorRefs_1.JutaConnectorRefs.BEFORE_CONNECTOR_REF, ctx)
